...
namespace PING.Feature.SitecoreConfigurationOverrideSystem // $NameSpaceToken
{
    public class PingSitecoreConfigOverrideReaderTemplate : ConfigReader // public class $ClassNameToken : $BaseTypeToken
    {
